...
export async function getBloks() {
  try {
    await requirePermission('master.blok.read');
...
export async function createBlok(formData: FormData) {
  try {
    await requirePermission('master.blok.create');
    const user = await getCurrentUser();
...
export async function updateBlok(formData: FormData) {
  try {
    await requirePermission('master.blok.update');
    const user = await getCurrentUser();
...
export async function deleteBlok(id: string) {
  try {
    await requirePermission('master.blok.delete');
    const user = await getCurrentUser();
