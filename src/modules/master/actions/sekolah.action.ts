...
export async function getSekolahs() {
  try {
    await requirePermission('master.sekolah.read');
...
export async function createSekolah(formData: FormData) {
  try {
    await requirePermission('master.sekolah.create');
    const user = await getCurrentUser();
...
export async function updateSekolah(formData: FormData) {
  try {
    await requirePermission('master.sekolah.update');
    const user = await getCurrentUser();
...
export async function deleteSekolah(id: string) {
  try {
    await requirePermission('master.sekolah.delete');
    const user = await getCurrentUser();
