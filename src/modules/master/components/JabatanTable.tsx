...
interface JabatanTableProps {
  data: JabatanEntity[];
  onEdit: (jabatan: JabatanEntity) => void;
  onDelete: (jabatanId: string) => void;
}

export function JabatanTable({ data, onEdit, onDelete }: JabatanTableProps) {
  const columns: ColumnDef<JabatanEntity>[] = [
    {
      accessorKey: 'name',
      header: 'Nama Jabatan',
