...
import { labTransactionItems } from '../schemas/lab.schema';
import { eq } from 'drizzle-orm';

export class LabTransactionItemRepository extends BaseRepository<typeof labTransactionItems> {
  constructor(dbClient?: DbClient) {
    super(labTransactionItems, dbClient);
  }
