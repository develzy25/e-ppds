...
import { labTransactions } from '../schemas/lab.schema';
import { eq } from 'drizzle-orm';

export class LabTransactionRepository extends BaseRepository<typeof labTransactions> {
  constructor(dbClient?: DbClient) {
    super(labTransactions, dbClient);
  }
