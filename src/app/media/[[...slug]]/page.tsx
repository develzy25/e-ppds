  ...
  return (
    <div className="space-y-6 p-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col gap-1.5 border-b border-border/30 pb-4 text-left">
        ...
        <p className="text-xs text-muted-foreground">Anda tidak memiliki izin akses modul media.
          Silakan gunakan simulasi switcher role di Header untuk berganti peran menjadi Ust. M. Ali (Kasie Lab yang merangkap Anggota Media).</p>
      </div>
