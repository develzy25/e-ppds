ALTER TABLE `pengurus_positions` ADD `created_at` text NOT NULL;--> statement-breakpoint
ALTER TABLE `pengurus_positions` ADD `updated_at` text NOT NULL;--> statement-breakpoint
...
ALTER TABLE `pengurus_roles` ADD `created_at` text NOT NULL;--> statement-breakpoint
ALTER TABLE `pengurus_roles` ADD `updated_at` text NOT NULL;--> statement-breakpoint
...
ALTER TABLE `role_permissions` ADD `created_at` text NOT NULL;--> statement-breakpoint
ALTER TABLE `role_permissions` ADD `updated_at` text NOT NULL;--> statement-breakpoint
